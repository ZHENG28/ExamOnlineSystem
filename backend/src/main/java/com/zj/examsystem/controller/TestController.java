...
public class TestController {
    ...
    @GetMapping("/findById")
    @ResponseBody
    public BaseResponseEntity findById(Integer testId) {
        return BaseResponseEntity.ok("", testService.findById(testId));
    }

    @GetMapping("/findExamTimeByTestId")
    @ResponseBody
    public BaseResponseEntity findExamTimeByTestId(Integer userId, Integer testId) {
    ...
    @PostMapping("/save")
    @ResponseBody
    public BaseResponseEntity save(Test test, Integer[] questionList, String[] shortAnswer, String status) {
    ...
    @PostMapping("/delete")
    @ResponseBody
    public BaseResponseEntity delete(Integer[] testId) {
