...
public class MajorController {
    ...
    @GetMapping("/findById")
    @ResponseBody
    public BaseResponseEntity findById(Integer majorId) {
        return BaseResponseEntity.ok("", majorService.findById(majorId));
    }

    @PostMapping("/save")
    @ResponseBody
    public BaseResponseEntity save(Major major, String status) {
    ...
    @PostMapping("/delete")
    @ResponseBody
    public BaseResponseEntity delete(Integer[] majorId) {
